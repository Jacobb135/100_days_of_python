...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        marks = ""
        checkmark_amount = math.floor(reps / 2)
        for _ in range(checkmark_amount):
            marks += "✔"
...
timer_label = Label(text="Timer", bg=YELLOW, fg=GREEN, highlightthickness=0, font=(FONT_NAME, 40, "bold"))
...
checkmark = Label(bg=YELLOW, fg=GREEN, pady=15, font=(FONT_NAME, 14, "bold"))
